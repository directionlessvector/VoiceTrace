...
function calculateTranscriptionClarity(text) {
...
function ambiguityPenalty(text, clarityScore) {
...
function applyVoiceConfidenceRules(lines, transcript, transcriptionClarityScore) {
...
function sanitizeLines(lines, transcript) {
...
function buildFallbackStructured(transcript) {
...
async function extractStructuredLedger(transcript, transcriptionClarityScore) {
    const apiKey = getGroqApiKey();
    const systemPrompt = [
...
async function processVoiceAudio(input) {
